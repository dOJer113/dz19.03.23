...
public class Main {
    public static void main(String[] args) {
        ...
        //System.out.println(persons.stream().filter(person -> person.getAge()>=18 && person.getAge()<=60 && person.getSex().equals(Sex.MAN)).map(person -> person.getFamily()).collect(Collectors.toList()));
